<%@ Page Title="飯店房型查編" Language="C#" MasterPageFile="~/backend/zMaster.master" AutoEventWireup="true" CodeFile="hotel_edit.aspx.cs" Inherits="backend_itinerary_hotel_edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
   ...
   <%-- <script src="../../js/jquery-ui-1.10.4.custom.min.js"></script>
    ...
    <script src="js/hotel_edit.js?v=<%= GetVersion() %>"></script>
    <style>
    ...
    <div id="wrap">
        <div class="container-fluid">
            ...
            <div class="input-zone">
                ...
                <span id="loading" style="display: none; color: blue;">
