<%@ Page Title="" Language="C#" MasterPageFile="~/backend/zMaster.master" AutoEventWireup="true" CodeFile="waiting_edit_wt.aspx.cs" Inherits="wating_edit_wt" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
  <link href="css/order_edit_wt.css" rel="stylesheet" />
  <script src="../js/paging.js?v=<%= GetVersion() %>"></script>
  <script src="js/waiting_edit_wt.js?v=<%= GetVersion() %>"></script>
  <style>
