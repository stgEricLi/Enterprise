<%@ Page Title="" Language="C#" MasterPageFile="~/backend/zMaster.master" AutoEventWireup="true" CodeFile="order_wt_payment.aspx.cs" Inherits="backend_order_order_wt_payment" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">   
    <script src="../js/utilities.js?v=<%= GetVersion() %>"></script>
    <script src="../js/paging.js?v=<%= GetVersion() %>"></script>
    <script src="js/order_wt_payment.js?v=<%= GetVersion() %>"></script>
    <style>
