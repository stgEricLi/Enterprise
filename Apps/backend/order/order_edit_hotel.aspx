<%@ Page Title="" Language="C#" MasterPageFile="~/backend/zMaster.master" AutoEventWireup="true" CodeFile="order_edit_hotel.aspx.cs" Inherits="backend_order_order_edit_hotel" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
  <link href="css/order_edit_wt.css" rel="stylesheet" />
  <script src="../js/paging.js?v=<%= GetVersion() %>"></script>
  <script src="js/order_edit_hotel.js?v=<%= GetVersion() %>"></script>
  <style>
  ...
  <div id="wrap">
    <div class="container-fluid">
      ...
      <div class="input-zone">
          <select id="ddlOption" class="form-control" style="width: 246px!important;">
             
              <option value="ACT">依活動查詢</option>
               <option value="DAY">依活動日期 YYYY-MM-DD</option>
        ...
        <button id="btnExport" type="button" class="btn btn-success">全部匯出</button>
