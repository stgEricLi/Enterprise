<%@ Page Title="" Language="C#" MasterPageFile="~/backend/zMaster.master" AutoEventWireup="true" CodeFile="order_edit_hotelBk.aspx.cs" Inherits="backend_order_order_edit_hotelBk" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
     <link href="css/order_edit_wt.css" rel="stylesheet" />
  <script src="../js/paging.js?v=<%= GetVersion() %>"></script>
  <script src="js/order_edit_hotel_Bk.js?v=<%= GetVersion() %>"></script>
  <style>
