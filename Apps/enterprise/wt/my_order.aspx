<%@ Page Language="C#" AutoEventWireup="true" CodeFile="my_order.aspx.cs" Inherits="enterprise_wt_my_order" %>
...
<head runat="server">
    ...
    <script src="js/myorder.js?v=<%= GetVersion() %>"></script>
    ...
    <div class="container-fluid">
        ...
        <div id="step2" class="steps">
            <div class="panel panel-primary ">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="glyphicon glyphicon-search"></span>&nbsp;&nbsp;您的報名清單</h3>
                </div>
                <div class="panel-body">
                    <table class="table">
                        <thead>
