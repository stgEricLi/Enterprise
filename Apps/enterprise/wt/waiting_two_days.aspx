<%@ Page Language="C#" AutoEventWireup="true" CodeFile="waiting_two_days.aspx.cs" Inherits="enterprise_wt_waiting_two_days" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>文曄科技線上報名二日遊候補</title>
    ...
    <script src="js/waiting_two_days.js?v=<%= GetVersion() %>"></script>
    <style>
        .listline td select {
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">線上報名候補已完成</h4>
                    </div>
