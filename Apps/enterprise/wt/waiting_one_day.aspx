<%@ Page Language="C#" AutoEventWireup="true" CodeFile="waiting_one_day.aspx.cs" Inherits="enterprise_wt_waiting_two_days" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>文瞱科技線上報名候補</title>
    ...
    <script src="js/waiting_one_day.js?v=<%= GetVersion() %>"></script>
    <style>
        .listline td select {
    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            <div style="text-align: center;">
                <h1 class="text-info">MCP海天青-文瞱科技線上報名候補</h1>
                        ...
                        <ul>
                            <li>
                                <select id="ddlRoom" class="form-control" style="width: 42%;">
                                    ...
                                    <option value="6">一共6位參加人(4位成人+2位三歲以下小孩)</option>    
                                </select>
                            </li>
