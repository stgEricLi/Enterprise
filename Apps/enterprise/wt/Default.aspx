    ...
    <div id="registration" class="container-fluid">
        <div class="row">
          ...
          <p>線上報名後，除公司補助名額外，如有額外人員參加，請您於收到信件後3天內將額外將費用匯至本公司承辦之旅行社。</p>
                --%>
                <p style="font-size: 18px;">線上報名後，除公司補助兩人房外，如訂三人房及四人房，請您於收到信件後3天內將額外費用匯至本公司承辦之旅行社。</p>
    ...
    <div id="contact" class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <h5>聯絡專線</h5>
                <p><span class="glyphicon glyphicon-phone"></span>&nbsp;02-29527535 #20 吳小姐 #36 周小姐</p>
                <p><span class="glyphicon glyphicon-phone"></span>&nbsp;02-29514509</p>
            </div>
            ...
            <div class="col-sm-4 slideanim">
                ...
                <p class="text-warning">吳依潔 (Jessica)</p>
            </div>
