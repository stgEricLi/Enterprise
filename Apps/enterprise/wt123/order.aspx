<%@ Page Language="C#" AutoEventWireup="true" CodeFile="order.aspx.cs" Inherits="enterprise_wt123_order" %>

<!DOCTYPE html>

<html>
<head runat="server">
  <title>文曄減重-課程註冊</title>
  ...
  <script src="js/order.js?v=<%= GetVersion() %>"></script>
</head>
<body>
    ...
    <div class="container-fluid">
        ...
        <div style="margin-top:24px; margin-bottom:24px;">
            <span class="titl">註冊方式</span>
            <select id="ddlOption" class="form-control" style="width:206px!important;">                
                <option value="one">個人（一人）</option>
                <option value="multip">團體（最多三人）</option>
            </select>
        </div>
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table class="table table-responsive">
                        <thead>
                            <tr>
                                <th>姓名</th><th>身份證</th><th>生日</th><th>手機</th><th>Email</th><th>工號</th><th><span id='btnAdd0' class='glyphicon glyphicon-plus' onclick='add_newline()' title='新增一列'></span></th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
